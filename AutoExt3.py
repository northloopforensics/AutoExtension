...
ctk.CTkLabel(app, text="This tool will locate files without a file extension found in the imput directory, identify the file type, and add the appropriate extension to copied files in the output directory.", font=('Arial', 12),wraplength=550).pack(pady=10)
